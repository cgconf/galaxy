...
function retrieveCRAVATInfo( retrieveChr, retrievePos, retrieveRef, retrieveAlt ){
  ...
  var positionKey = retrieveChr + "_" + retrievePos
      // 10/20/17 CLG
      // Changing the cravat URL in order to allow the hg19 to continue to function until we get chgr38 up
  var cravat_prefix = "//hg19.cravat.us/CRAVAT/rest/service/query?mutation="

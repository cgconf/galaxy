...
<head>
    ...
    <!-- IGV JS-->
    <script type="text/javascript" src="${h.url_for('//igv.org/web/release/2.0.0-beta3/dist/igv.js')}"></script>
    <!-- Data Table -->
...
<body>
   ...
   <%
       ...
       viz_list1 = ['finspector_bed','FusionJuncSpan','cytoBand','finspector_fa','finspector_idx']
   ...
   %>
    ...
    $.getJSON(ajaxUrl, function(data){
         ...
         data_modified[ "referenceIndex" ] = "/datasets/" + url_dict["finspector_idx"] + "/display?to_ext=txt";
